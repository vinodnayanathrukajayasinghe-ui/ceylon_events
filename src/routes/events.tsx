  ...
  head: () => ({
    meta: [
      { title: "Upcoming Luxury Events in Dubai — Ceylon Kandy Events" },
      {
        name: "description",
        content:
          "Discover upcoming galas, concerts, and exclusive ticketed events curated by Ceylon Kandy Events in Dubai and the UAE.",
      },
...
const FALLBACK = [
  {
    ...
    short_description: "An intimate evening of Dubai's most distinguished guests.",
  ...
  },
  {
    ...
    short_description: "World-class artists under the Arabian sky.",
  ...
  },
  {
    ...
    short_description: "Dubai's most exclusive countdown above the city skyline.",
  ...
  },
  {
    ...
    short_description: "South Asian cinema reimagined for Dubai's glitterati.",
  ...
  {
    id: "5",
    slug: "vogue-fashion-soiree",
    title: "Vogue Fashion Soirée",
    short_description: "Couture meets Arabian glamour in a one-night runway.",
  ...
  {
    id: "6",
    slug: "ramadan-iftar-soiree",
    title: "Ramadan Iftar Soirée",
    short_description: "An exquisite evening of tradition and modern luxury.",
    ...
    <SiteLayout>
      <section className="pt-24 pb-12 text-center container-luxe">
        ...
        <p className="mt-6 text-muted-foreground max-w-xl mx-auto">
          A curated calendar of luxury experiences across Dubai and beyond.
        </p>
      </section>
        ...
        <div className="container-luxe grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filtered.map((e) => (
            ...
            >
              ...
              {e.status === "sold_out" && (
                <span className="absolute top-4 right-4 px-3 py-1.5 text-[10px] tracking-[0.25em] uppercase bg-onyx/80 text-gold border border-gold rounded-sm">
                  Sold Out
                </span>
              )}
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-gold font-medium">
                    {e.base_price && e.base_price > 0
                      ? `${e.currency} ${e.base_price}`
                      : "Reserved"}
                  </span>
                </div>
      ...
      <section className="py-24 border-t border-gold-soft bg-charcoal/30">
        <div className="container-luxe">
          ...
          <div className="mt-10 text-center">
            <Link
              to="/book"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-gold text-primary-foreground uppercase tracking-[0.2em] text-xs font-medium rounded-sm hover:shadow-gold-lg transition-all"
            >
